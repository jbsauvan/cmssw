...
void HGCalHistoClusteringWrapper::convertAlgorithmOutputs(
  ...
  for (const auto& cluster : clusterSums) {
    ...
    multicluster.setHw_sigma_e_quotient(cluster->sigma_e_quotient());
    multicluster.setHw_sigma_e_fraction(cluster->sigma_e_fraction());
    multicluster.setHw_mean_z_quotient(cluster->mean_z_quotient());
    multicluster.setHw_mean_z_fraction(cluster->mean_z_fraction());
    multicluster.setHw_mean_phi_quotient(cluster->mean_phi_quotient());
    multicluster.setHw_mean_phi_fraction(cluster->mean_phi_fraction());
    multicluster.setHw_mean_eta_quotient(cluster->mean_eta_quotient());
    multicluster.setHw_mean_eta_fraction(cluster->mean_eta_fraction());
    multicluster.setHw_mean_roz_quotient(cluster->mean_roz_quotient());
    multicluster.setHw_mean_roz_fraction(cluster->mean_roz_fraction());
    multicluster.setHw_sigma_z_quotient(cluster->sigma_z_quotient());
    multicluster.setHw_sigma_z_fraction(cluster->sigma_z_fraction());
    multicluster.setHw_sigma_phi_quotient(cluster->sigma_phi_quotient());
    multicluster.setHw_sigma_phi_fraction(cluster->sigma_phi_fraction());
    multicluster.setHw_sigma_eta_quotient(cluster->sigma_eta_quotient());
    multicluster.setHw_sigma_eta_fraction(cluster->sigma_eta_fraction());
    multicluster.setHw_sigma_roz_quotient(cluster->sigma_roz_quotient());
    multicluster.setHw_sigma_roz_fraction(cluster->sigma_roz_fraction());
    multicluster.setHw_e_em_over_e_quotient(cluster->e_em_over_e_quotient());
    multicluster.setHw_e_em_over_e_fraction(cluster->e_em_over_e_fraction());
    multicluster.setHw_e_em_core_over_e_em_quotient(cluster->e_em_core_over_e_em_quotient());
    multicluster.setHw_e_em_core_over_e_em_fraction(cluster->e_em_core_over_e_em_fraction());
    multicluster.setHw_e_h_early_over_e_quotient(cluster->e_h_early_over_e_quotient());
    multicluster.setHw_e_h_early_over_e_fraction(cluster->e_h_early_over_e_fraction());
