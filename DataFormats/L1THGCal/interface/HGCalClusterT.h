...
namespace l1t {
  ...
  public:
    ...
    void setHw_sigma_e_quotient(unsigned long int sigma_e_quotient) { hw_sigma_e_quotient_ = sigma_e_quotient; }
    void setHw_sigma_e_fraction(unsigned long int sigma_e_fraction) { hw_sigma_e_fraction_ = sigma_e_fraction; }
    void setHw_mean_z_quotient(unsigned long int mean_z_quotient) { hw_mean_z_quotient_ = mean_z_quotient; }
    void setHw_mean_z_fraction(unsigned long int mean_z_fraction) { hw_mean_z_fraction_ = mean_z_fraction; }
    void setHw_mean_phi_quotient(unsigned long int mean_phi_quotient) { hw_mean_phi_quotient_ = mean_phi_quotient; }
    void setHw_mean_phi_fraction(unsigned long int mean_phi_fraction) { hw_mean_phi_fraction_ = mean_phi_fraction; }
    void setHw_mean_eta_quotient(unsigned long int mean_eta_quotient) { hw_mean_eta_quotient_ = mean_eta_quotient; }
    void setHw_mean_eta_fraction(unsigned long int mean_eta_fraction) { hw_mean_eta_fraction_ = mean_eta_fraction; }
    void setHw_mean_roz_quotient(unsigned long int mean_roz_quotient) { hw_mean_roz_quotient_ = mean_roz_quotient; }
    void setHw_mean_roz_fraction(unsigned long int mean_roz_fraction) { hw_mean_roz_fraction_ = mean_roz_fraction; }
    void setHw_sigma_z_quotient(unsigned long int sigma_z_quotient) { hw_sigma_z_quotient_ = sigma_z_quotient; }
    void setHw_sigma_z_fraction(unsigned long int sigma_z_fraction) { hw_sigma_z_fraction_ = sigma_z_fraction; }
    void setHw_sigma_phi_quotient(unsigned long int sigma_phi_quotient) { hw_sigma_phi_quotient_ = sigma_phi_quotient; }
    void setHw_sigma_phi_fraction(unsigned long int sigma_phi_fraction) { hw_sigma_phi_fraction_ = sigma_phi_fraction; }
    void setHw_sigma_eta_quotient(unsigned long int sigma_eta_quotient) { hw_sigma_eta_quotient_ = sigma_eta_quotient; }
    void setHw_sigma_eta_fraction(unsigned long int sigma_eta_fraction) { hw_sigma_eta_fraction_ = sigma_eta_fraction; }
    void setHw_sigma_roz_quotient(unsigned long int sigma_roz_quotient) { hw_sigma_roz_quotient_ = sigma_roz_quotient; }
    void setHw_sigma_roz_fraction(unsigned long int sigma_roz_fraction) { hw_sigma_roz_fraction_ = sigma_roz_fraction; }
    void setHw_e_em_over_e_quotient(unsigned long int e_em_over_e_quotient) {
      hw_e_em_over_e_quotient_ = e_em_over_e_quotient;
    }
    void setHw_e_em_over_e_fraction(unsigned long int e_em_over_e_fraction) {
      hw_e_em_over_e_fraction_ = e_em_over_e_fraction;
    }
    void setHw_e_em_core_over_e_em_quotient(unsigned long int e_em_core_over_e_em_quotient) {
      hw_e_em_core_over_e_em_quotient_ = e_em_core_over_e_em_quotient;
    }
    void setHw_e_em_core_over_e_em_fraction(unsigned long int e_em_core_over_e_em_fraction) {
      hw_e_em_core_over_e_em_fraction_ = e_em_core_over_e_em_fraction;
    }
    void setHw_e_h_early_over_e_quotient(unsigned long int e_h_early_over_e_quotient) {
      hw_e_h_early_over_e_quotient_ = e_h_early_over_e_quotient;
    }
    void setHw_e_h_early_over_e_fraction(unsigned long int e_h_early_over_e_fraction) {
