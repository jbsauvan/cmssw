...
def createSampleListsFromHisto(analysis_dir='/afs/cern.ch/user/s/steggema/work/public/mt/NewProd',
    ...
    samples_essential = [
        ...
        BasicHistogramCfg(name='ZL', dir_name='DYJetsToLL_M50_LO', ana_dir=analysis_dir, histo_file_name='', histo_name='', xsec=DYJetsToLL_M50_LO.xSection, sumweights=DYJetsToLL_M50_LO.nGenEvents),
        BasicHistogramCfg(name='W', dir_name='WJetsToLNu_LO', ana_dir=analysis_dir, histo_file_name='', histo_name='', xsec=WJetsToLNu_LO.xSection, sumweights=WJetsToLNu_LO.nGenEvents),
        ...
        BasicHistogramCfg(name='TT', dir_name='TT_pow_ext', ana_dir=analysis_dir, histo_file_name='', histo_name='', xsec=TT_pow.xSection, sumweights=TT_pow.nGenEvents),
    ...
    if 'TauMu' in tree_prod_name or 'MuMu' in tree_prod_name:
        samples_data = [
            BasicHistogramCfg(name='data_obs', dir_name='SingleMuon_Run2015D_v4', ana_dir=analysis_dir, histo_file_name='', histo_name='', is_data=True),
            BasicHistogramCfg(name='data_obs', dir_name='SingleMuon_Run2015D_05Oct', ana_dir=analysis_dir, histo_file_name='', histo_name='', is_data=True),
        ...
        samples_data = [
            BasicHistogramCfg(name='data_obs', dir_name='SingleElectron_Run2015D_v4', ana_dir=analysis_dir, histo_file_name='', histo_name='', is_data=True),
            BasicHistogramCfg(name='data_obs', dir_name='SingleElectron_Run2015D_05Oct', ana_dir=analysis_dir, histo_file_name='', histo_name='', is_data=True),
            # SampleCfg(name='data_obs', dir_name='SingleMuon_Run2015B_05Oct', ana_dir=analysis_dir, tree_prod_name=tree_prod_name, is_data=True)
        ]
