...
## Output
version  = 'v160303'
plot_dir = "SSRegion/FakeRateEstimation_postfit/{VERSION}/"

histo_base_dir = '/afs/cern.ch/work/j/jsauvan/Projects/Htautau_Run2/CMSSW/CMSSW_7_1_21_patch2/src/CombineHarvester/HttFakes/scripts/output/LIMITS/{VERSION}/mt/'.format(VERSION=version)
...
histo_base_dir_raw = '/afs/cern.ch/work/j/jsauvan/Projects/Htautau_Run2/Histos/StudyFakeRate/MuTau/FakeFactorUncertainties_SS/'
