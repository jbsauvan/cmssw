...
isotau = Cut('l2_byCombinedIsolationDeltaBetaCorr3Hits>=2')
isotau_anti = Cut('l2_byCombinedIsolationDeltaBetaCorr3Hits<2')

isomu_medium1 = Cut('l1_reliso05<0.15 && l1_reliso05>0.10')
isomu_medium2 = Cut('l1_reliso05<0.15 && l1_reliso05>0.05')
isomu_medium3 = Cut('l1_reliso05<0.15 && l1_reliso05>0.01')
