...
## Output
version  = 'v160304'
plot_dir = "SSRegion/FakeRateEstimation/FakeFactorType_{FAKETYPE}/{VERSION}/"
#publish_plots = True
...
systematics['CombinedSS'] = {
    'FakeFactorSys': ['ShiftNonClosure_HighMTSS_%i'%i for i in xrange(4)]+['ShiftNonClosure_QCDSS_%i'%i for i in xrange(4)],
    'MTCorr': ['ShiftStatMTCorr_Up', 'ShiftStatMTCorr_Down', 'ShiftBinningMTCorr_Up', 'ShiftBinningMTCorr_Down'],
    'Fractions':['ShiftFractionSSW_Up','ShiftFractionSSW_Down','ShiftFractionSSQCD_Up','ShiftFractionSSQCD_Down','ShiftFractionSSTT_Up','ShiftFractionSSTT_Down']+fractionStatShifts
