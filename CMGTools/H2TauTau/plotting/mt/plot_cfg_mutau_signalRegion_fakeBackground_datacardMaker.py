...
## Output
version  = 'v160308'
plot_dir = "signalRegion/FakeRateEstimation/Datacards/{VERSION}/"
...
systematics['Combined'] = {
    'Nominal':'',
    'FakeFactorHighMTUp': 'ShiftNonClosure_HighMT',
    'FakeFactorHighMTDown': '',
    'FakeFactorQCDSSUp': 'ShiftNonClosure_QCDSS',
    'FakeFactorQCDSSDown': '',
    ...
    'FractionsWUp':'ShiftFractionW_Up',
    'FractionsWDown':'ShiftFractionW_Down',
    'FractionsQCDUp':'ShiftFractionQCD_Up',
    'FractionsQCDDown':'ShiftFractionQCD_Down',
    'FractionsTTUp':'ShiftFractionTT_Up',
    'FractionsTTDown':'ShiftFractionTT_Down',
    #+fractionStatShifts
